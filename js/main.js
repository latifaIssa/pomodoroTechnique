...
function reset() {
    ...
    document.getElementById("timer-panel").style.backgroundColor = "LightCoral";
...
function breakCountDown() {
    document.getElementById("timer-panel").style.backgroundColor = "Orchid";
    showTime();
    if (count < 0) {
        clearInterval(breakSession);
        breakSession = null;
        var message = setTimeout(function() {
            document.getElementById("showtime").innerHTML = "Break duration completed!";
